...
urlpatterns = [
                  ...
                  path('sitemap.xml/',
                       TemplateView.as_view(template_name='restaurant/sitemap.xml', content_type='text/xml')),
                  path('robots.txt/',
                       TemplateView.as_view(template_name='restaurant/robots.txt', content_type='text/plain')),
                  path('', views.home, name='restaurant-home'),
