...
def image_path(instance, filename):
    ...
    return f'{instance}/image/pic_{num}{suff}'


class Hero(models.Model):
    restaurantName = models.CharField(max_length=100, verbose_name="Restaurant name", default="El Deliciós d'Etiopia")
    restaurantMotto = models.TextField(verbose_name="Restaurant Motto",
                                       default='Fresh and Delicious Ethiopian Food just for you!')
...
class Footer(models.Model):
    ...
    footerBody = models.CharField(max_length=200, verbose_name="Restaurant Motto",
                                  default='Fresh and Delicious Ethiopian Food just for you!')
